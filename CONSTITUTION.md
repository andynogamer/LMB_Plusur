...
| AR markers | Local JSON | `assets/ar_markers.json` | ?3 grading markers (US-05). |
...
| R-02 | **Resolved in US-05:** `marcador_estadio_diablos`, `marcador_jugador_guerreros`, `marcador_trofeo_pericos` (see `assets/ar_markers.json`). |
